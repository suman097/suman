            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                        ...
                        <small>Edit Register company from admin</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="<?php echo base_url('company'); ?>">Edit Register Company</a></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                                            ...
                                            <div class="row-fluid">
                                                <div class="span6 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span12" name = "name" value = "<?php echo $details->company_name; ?>"> 
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <select  class="m-wrap span12" name = "country">
                                                                    ...
                                                                    if (isset($country)) {
                                                                        foreach ($country as $try) {
                                                                            if($try->id == $details->company_country){
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12 ">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <textarea class="span12 ckeditor m-wrap" name="details" rows="6" data-error-container="#editor2_error"><?php echo $details->company_name; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
