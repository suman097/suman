        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        Abuse <small>Show All Abuse</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show All Abuse</div>
                            <div class="tools">
                                ...
                                <tbody>
                                    ...
                                    if (isset($abuse)) {
                                        ...
                                        foreach ($abuse as $ab) {
                                            ...
                                            <tr >
                                                <td><?php echo $c; ?></td>
                                                <td><?php echo $ab->nikname; ?></td>
                                                <td><?php echo $ab->report; ?></td>
                                            </tr>
