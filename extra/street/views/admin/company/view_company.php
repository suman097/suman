            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="">Show All Company</a></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show All Company</div>
                            <div class="tools">
                                    ...
                                    if (isset($company)) {
                                        ...
                                        foreach ($company as $com) {
                                            ...
                                            <tr >
                                                ...
                                                <td><?php echo $com->company_description; ?></td>
                                                <td><img src = "<?php echo base_url(); ?>images/company/<?php echo $com->company_logo; ?>" height = "70" width = "70"></td>
                                                <td><?php echo $com->country; ?></td>
                                                <td class="center" id="status">
                                                    <?php
                                                    if ($com->status == "1") {
                                                        ?>
                                                        <span style="margin-left:35px;" class="status_<?php echo $com->id; ?>" onclick="return changeStatus(<?php echo $com->id; ?>, 'company');"> 
                                                    ...
                                                    <?php } ?>                                    </td>
                                                <td style="width:70px;">
                                                    <a href="<?php echo base_url('company/editCompany') . '/' . $com->id; ?>" title="edit"><img src = "<?php echo base_url() . 'images/icons/edit.png' ?>" alt="Edit" height="30" width="30"></a>
                                                    <a href="<?php echo base_url('common/isDeleted'); ?>/<?php echo $com->id; ?>/company/company/manageCompany" title="delete"><img src = "<?php echo base_url() . 'images/icons/delete.png' ?>" alt="Delete" height="30" width="30"></a>
                                                </td>
                                            </tr>
