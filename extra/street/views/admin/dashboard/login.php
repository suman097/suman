...
<html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>Company Review Management System | Login Page</title>
    ...
    <body class="login">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <span style="font-size: 22px; font-weight: bold; color: #ffffff; padding-left: 4px;">Company Review </span> <span style="font-size: 22px; font-weight: bold; color: #ff2300;">Management System</span>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
