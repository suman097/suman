    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                        Edit Company Banner Text
                        <small>Edit Banner Text from admin</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="<?php echo base_url('image'); ?>">Edit Company Banner Text</a></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-reorder"></i>Company Banner Text</div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="<?php echo base_url('image/index'); ?>" class="horizontal-form" method="post" enctype="multipart/form-data">
                                            <h3 class="form-section">Company Banner Text</h3>
                                            
                                                <div class="row-fluid">
                                                    <div class="span12 ">
                                                        <div class="control-group">
                                                            <label class="control-label" >Company Banner Text</label>
                                                            <div class="controls">
                                                                <textarea class="span12 ckeditor m-wrap" name="details" rows="6" data-error-container="#editor2_error"><?php echo $details->banner_text; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
