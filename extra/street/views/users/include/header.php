...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/frontend/js/jquery.tokenize.js"></script>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/frontend/css/jquery.tokenize.css" />
        <script type="text/javascript">
                                        var jq = $.noConflict();
                                        jq(document).ready(function(){
                                jq('#tokenize').tokenize();
                                });                           
                                    </script>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        if (isset($users_type)) {
                            ?>
                            <a href = "<?php echo base_url('home/profile'); ?>"><button type="button" class="btn btn-primary" >Profile</button></a>
                            <?php
                        } else {
                            ?>
                    ...
                    <form class="form-signin" name = "register_fom" method = "post" action = "">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <select id="tokenize" multiple="multiple" class="tokenize-sample" style="width:300px; color: #555555;" name = "country">
                                    <?php
                                    if (isset($country)) {
                                        $count = 0;
