														...
														<div id="dropdown-thumbnail-preview">
																<!--                                <ul class="nav navbar-nav">
																																		<li class="dropdown dropdown-large">
																																				<a href="#" class="dropdown-toggle" style="color:#666; font-size:14px;" data-toggle="dropdown"><span id = "selected_country_name">Select Country</span> <b class="caret"></b></a>
...
<!--<form class="navbar-form" action="<?php echo base_url('home/searchCompany'); ?>" method="post" onSubmit="return submitCheckCountry();">
